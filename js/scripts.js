...
for(var i = 0; i < contentList.childNodes.length; i++) {
	if(contentList.childNodes[i].nodeType === 1) {
		let targetNode = contentList.childNodes[i];
		targetNode.addEventListener("click", fillArticle);
	}
}
